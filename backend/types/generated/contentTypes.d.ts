...
export interface ApiAnimalReportAnimalReport
  extends Struct.CollectionTypeSchema {
...
export interface ApiAppFontAppFont extends Struct.SingleTypeSchema {
  collectionName: 'app_fonts';
  info: {
    displayName: 'App Font';
    pluralName: 'app-fonts';
    singularName: 'app-font';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiCropReportCropReport extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    CropType: Schema.Attribute.String;
    Disease: Schema.Attribute.String;
    doctor: Schema.Attribute.Relation<'manyToOne', 'api::doctor.doctor'>;
    FarmerName: Schema.Attribute.String;
    feedbacks: Schema.Attribute.Relation<'oneToMany', 'api::feedback.feedback'>;
...
export interface ApiDarkThemeDarkTheme extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::dark-theme.dark-theme'
    > &
      Schema.Attribute.Private;
    onPrimary: Schema.Attribute.String;
    onSurface: Schema.Attribute.String;
    onSurfaceVariant: Schema.Attribute.String;
    primary: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    surface: Schema.Attribute.String;
    surfaceContainer: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDoctorDoctor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    animal_reports: Schema.Attribute.Relation<
      'oneToMany',
      'api::animal-report.animal-report'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    crop_reports: Schema.Attribute.Relation<
      'oneToMany',
      'api::crop-report.crop-report'
    >;
    Degree: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiFeedbackFeedback extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    crop_report: Schema.Attribute.Relation<
      'manyToOne',
      'api::crop-report.crop-report'
    >;
...
export interface ApiLightThemeLightTheme extends Struct.SingleTypeSchema {
  collectionName: 'light_themes';
  info: {
    description: '';
    displayName: 'LightTheme';
    pluralName: 'light-themes';
    singularName: 'light-theme';
  };
  options: {
    draftAndPublish: false;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::animal-report.animal-report': ApiAnimalReportAnimalReport;
      'api::app-font.app-font': ApiAppFontAppFont;
      'api::crop-report.crop-report': ApiCropReportCropReport;
